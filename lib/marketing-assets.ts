...
export const cqImages = {
  ...
  heroCity: `${CQ_ASSET_PATH}/hero-city-beam.png`,
  heroCityOriginal: `${CQ_ASSET_PATH}/11_hero_city_sunset.png`,
  tornPaper: `${CQ_ASSET_PATH}/torn-paper-wide.png`,
  tornMap: `${CQ_ASSET_PATH}/14_torn_map_texture.png`,
  texture: `${CQ_ASSET_PATH}/15_texture_swatches.png`,
  mapHud: `${CQ_ASSET_PATH}/adventure-map-hud.png`,
  mapMark: `${CQ_ASSET_PATH}/10_canton_ohio_map_mark.png`,
  cantonSign: `${CQ_ASSET_PATH}/canton-plaza-sign.png`,
  mckinleyStairs: `${CQ_ASSET_PATH}/mckinley-monument-stairs.png`,
  mckinleySunset: `${CQ_ASSET_PATH}/mckinley-monument-sunset.png`,
  palace: `${CQ_ASSET_PATH}/palace-theatre.png`,
  butterflyMural: `${CQ_ASSET_PATH}/butterfly-mural.png`,
  octopusMural: `${CQ_ASSET_PATH}/octopus-mural.png`,
  musicBlock: `${CQ_ASSET_PATH}/music-block-mural.png`,
  coffeeQr: `${CQ_ASSET_PATH}/coffee-qr-counter.png`,
  footballWide: `${CQ_ASSET_PATH}/football-sculpture-wide.png`,
  footballClose: `${CQ_ASSET_PATH}/football-sculpture-close.png`,
