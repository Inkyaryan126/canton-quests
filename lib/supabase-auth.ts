  ...
  if (isSupabaseConfigured && supabase) {
    ...
    if (!err1 && playerByUserId) {
      return {
        ...
        playerImageVisibility: playerByUserId.player_image_visibility || 'public',
      ...
      if (!err2 && legacyPlayer) {
        ...
        if (!claimErr && claimedPlayer) {
          return {
            ...
            playerImageVisibility: claimedPlayer.player_image_visibility || 'public',
  ...
  if (isSupabaseConfigured && supabase) {
    ...
    const { data: inserted, error: insertErr } = await db
      ...
      .insert({
        ...
        player_image_visibility: params?.playerImageVisibility || 'public',
    ...
    return {
      ...
      playerImageVisibility: inserted.player_image_visibility || 'public',
