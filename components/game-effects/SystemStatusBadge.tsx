...
import { Shield, Radar, CheckCircle2, ShieldAlert } from 'lucide-react';
...
const ICON: Record<SystemStatus, React.ComponentType<{ size?: number; className?: string }>> = {
  armed: Shield,
  scanning: Radar,
...
export default function SystemStatusBadge({
  ...
  return (
    // No ARIA live role here by design: this sits inside overlays that
    // already carry `role="status"`/`aria-live` themselves, and a second
    // nested live region would double-announce every state change.
