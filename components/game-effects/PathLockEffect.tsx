  ...
  return (
    ...
    >
      ...
      <CqTransition
        show={mounted}
        reducedMotion={reducedMotion}
        className="relative z-10 max-w-md w-full bg-[#07090e]/95 border-2 rounded-3xl p-6 sm:p-8 text-center space-y-5 shadow-2xl overflow-hidden cq-transition-settle"
        style={{
