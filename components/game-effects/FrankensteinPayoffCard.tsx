...
import { Radio, AlertTriangle, Eye, ShieldCheck, ChevronRight } from 'lucide-react';
        ...
        <div className="space-y-4">
          ...
          <div className="p-3.5 rounded-xl bg-[#040407] border border-purple-500/25 space-y-2">
            ...
            <p className="text-xs text-stone-300 italic leading-relaxed">
              &ldquo;Record confirmed. Hold... that&apos;s not right. I&apos;m seeing another signature attached to the file.&rdquo;
            </p>
          </div>
          ...
          <div className="pt-2 border-t border-purple-500/20 flex items-center justify-between flex-wrap gap-3">
            <div className="text-[11px] font-mono text-purple-200/80">
              <span className="text-amber-300 font-bold">NEXT FREQUENCY:</span> OCTOBER HALLOWEEN EVENT
            </div>
            <button
              type="button"
