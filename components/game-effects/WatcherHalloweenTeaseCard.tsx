...
import { WATCHER_HALLOWEEN_TEASE } from '@/lib/watchers';
          ...
          {isIntercepted && (
            <CqTransition show={true} reducedMotion={reducedMotion}>
              <VerificationResult
                ...
                message="W-01 passive monitoring frequency identified. Reactivation locked for the October Halloween campaign."
                reducedMotion={reducedMotion}
              />
            </CqTransition>
          )}
