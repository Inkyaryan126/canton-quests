...
describe('Operation entry uses the actual mission lifecycle', () => {
  beforeEach(() => {
    // Next uses the automatic JSX runtime; Vitest's existing config uses classic JSX.
  ...
  it('renders the provided title without mutating event data', () => {
    ...
    // React escapes the canonical title, just as the actual page does.
  ...
  it('removes startup entirely after handoff while retaining unmodified page children', () => {
    ...
    // No transformed ancestor may capture fixed mobile controls on the real page.
