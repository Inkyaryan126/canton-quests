...
describe('runCityValidation', () => {
  ...
  it('MISSING_PROVENANCE: WARNING for a draft package, ERROR for a ready package', () => {
    ...
    draft.districts = [{ slug: 'd1', name: 'District 1' }];
    draft.territories = [{ slug: 't1', name: 'T1', districtSlug: 'd1', baseValue: 100 }];
  ...
  it('PRIVACY_UNCLASSIFIED: WARNING for a draft package, ERROR for a ready package', () => {
    ...
    draft.districts = [{ slug: 'd1', name: 'District 1' }];
    draft.territories = [
      { slug: 't1', name: 'T1', districtSlug: 'd1', baseValue: 100, sourceRefs: ['n/a'] },
    ];
    draft.properties = [
      {
        slug: 'p1',
