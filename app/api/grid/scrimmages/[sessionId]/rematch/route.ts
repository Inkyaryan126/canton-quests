...
import { resetGridScrimmageSessionForRematch } from '@/lib/grid/server/scrimmage-service';
...
export async function POST(
  ...
  try {
    const scrimmage = await resetGridScrimmageSessionForRematch(
    ...
    const message =
      error instanceof Error
        ? error.message
        : 'Failed to reopen Grid scrimmage.';
