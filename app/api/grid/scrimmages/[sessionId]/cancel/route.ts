...
import { cancelGridScrimmageSession } from '@/lib/grid/server/scrimmage-service';
...
export async function POST(
  ...
  try {
    const scrimmage = await cancelGridScrimmageSession(
    ...
    const message =
      error instanceof Error
        ? error.message
        : 'Failed to cancel Grid scrimmage.';
