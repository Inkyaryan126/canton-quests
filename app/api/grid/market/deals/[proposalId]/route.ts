...
import { cancelGridPlayerDirectDeal } from '@/lib/grid/server/direct-deal-market-service';
...
export async function DELETE(
  ...
  try {
    const deal = await cancelGridPlayerDirectDeal(
    ...
    const message =
      error instanceof Error ? error.message : 'Failed to cancel Direct Deal.';
