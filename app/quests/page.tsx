...
const pathFilters: { label: string; value: PathFilter; icon: any; color: string; desc: string }[] = [
  ...
  { label: 'Mother Goose Land', value: 'challenge', icon: Zap, color: '#ef4444', desc: 'Mother Goose Land & 9th St Corridor' },
  { label: 'Monument Park', value: 'secret', icon: KeyRound, color: '#a855f7', desc: 'West Lawn Cemetery & The Watcher Chain' },
];
