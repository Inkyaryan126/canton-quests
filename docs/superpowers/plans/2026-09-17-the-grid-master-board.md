...
- [ ] **Step 3: Implement minimal contracts, catalog, and classifier**
...
- [ ] **Step 1: Add failing collector tests using fixture evidence**
...
- [ ] **Step 2: Run the real read-only board**
...
- [ ] **Step 3: Prove ordinary execution is read-only**
...
- [ ] **Step 5: Final commit if verification required corrective edits**
