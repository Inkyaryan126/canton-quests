...
| 6 | `familydoor.png` | `public/canton-quests/familydoor.png` | `/canton-quests/familydoor.png` | `ThreePathSelector.tsx`, `PathLockEffect.tsx`, `FamilyLanding.tsx` | FAMILY Path Doorway (Arts District) | 3-column desktop / vertical mobile portal | 534x475 PNG |
| 7 | `challengedoor.png` | `public/canton-quests/challengedoor.png` | `/canton-quests/challengedoor.png` | `ThreePathSelector.tsx`, `PathLockEffect.tsx`, `ChallengeLanding.tsx` | CHALLENGE Path Doorway (Mother Goose Land) | Crimson portal visual with speed/kinetic signal | 467x467 PNG |
| 8 | `secretdoor.png` | `public/canton-quests/secretdoor.png` | `/canton-quests/secretdoor.png` | `ThreePathSelector.tsx`, `PathLockEffect.tsx`, `SecretLanding.tsx` | SECRET Path Doorway (Monument Park) | Ultraviolet cipher portal with sequential lock | 467x467 PNG |
| 9 | `palace.png` | `public/canton-quests/palace.png` | `/canton-quests/palace.png` | `lib/marketing-assets.ts`, `app/page.tsx`, `app/quests/page.tsx` | Palace Theatre Real Landmark Art | Arts District / Family quest backdrop & destination card | 781x919 PNG |
